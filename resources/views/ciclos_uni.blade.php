...
<head>
    ...
    <meta name="description" content="Domina física, química y matemáticas con nuestro ciclo especializado UNI. La mejor preparación exigente en Pucallpa para ingresar a la ingeniería.">
    <meta name="keywords" content="ciclo uni, preparación ingeniería, academia uni pucallpa, matemáticas nivel uni, next level uni">
    <meta property="og:title" content="Ciclo Especializado UNI | Next Level">
...
<body>
    ...
    <section class="section-ciclo-uni">
        <div class="container-minimal">
            <h2 class="title-display">¡CICLOS UNI!</h2>
        ...
        <div class="tab-content-container"></div>
            ...
            <div id="anual" class="ciclo-panel active">
                <div class="pricing-card-modern">
                    <div class="card-info">
                        ...
                        <h3 class="cycle-name">Ciclo Anual <span>UNI</span></h3>
            ...
            <div id="semestral" class="ciclo-panel">
                <div class="pricing-card-modern">
                    <div class="card-info">
                        <span class="badge-status">DISPONIBLE 2026</span>
                        <h3 class="cycle-name">Ciclo Semestral <span>UNI</span></h3>
                        <div class="date-minimal">
                            <div class="date-row">
                                <i class="fa-regular fa-calendar"></i>
                                <span>23 Mar - 05 Dic</span>
            ...
            <div id="verano" class="ciclo-panel">
                <div class="pricing-card-modern">
                    <div class="card-info">
                        <span class="badge-status">DISPONIBLE 2026</span>
                        <h3 class="cycle-name">Ciclo Verano <span>UNI</span></h3>
                        <div class="date-minimal">
                            <div class="date-row">
                                <i class="fa-regular fa-calendar"></i>
                                <span>23 Mar - 05 Dic</span>
