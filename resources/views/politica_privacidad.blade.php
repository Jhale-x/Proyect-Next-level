...
<body>
    ...
    <section class="terminos-condiciones">
        ...
        <p>Esta Política de Privacidad describe cómo recopilamos, utilizamos, almacenamos, protegemos y, en su caso, compartimos o
            ...
            su Reglamento aprobado por Decreto Supremo N° 003-2013-JUS (y modificaciones posteriores, incluyendo DS 016-2024-JUS),
            y demás normativa aplicable en la República del Perú.</p>

        <p>Al acceder a nuestro sitio web, inscribirse en cursos, clases, talleres, simulacros o cualquier servicio, o
            proporcionarnos datos personales por cualquier medio (incluyendo WhatsApp, correo electrónico, formularios o
            presencialmente), usted (el “Titular de los Datos”, “Usuario”, “Estudiante” o “Apoderado”) acepta las prácticas
            descritas en esta Política. Si no está de acuerdo, por favor no proporcione sus datos ni utilice nuestros servicios.</p>
        ...
        <p>Recopilamos datos personales necesarios para prestar nuestros servicios educativos (preparación preuniversitaria,
            refuerzo escolar, talleres, asesorías, material educativo, etc.). Según el caso, podemos tratar:</p>
        <ul>
            ...
            <li>Datos de apoderados (obligatorio para menores de 18 años): nombres, DNI, relación con el estudiante, teléfono y
                correo.</li>
            <li>Datos académicos: colegio de procedencia, grado/nivel educativo, notas o resultados previos (si se proporcionan),
                carrera o universidad de interés.</li>
        ...
        <p>Nos regimos por los principios de la Ley N° 29733: legalidad, consentimiento, finalidad, proporcionalidad, calidad,
            seguridad, disponibilidad de recurso y nivel de protección adecuado.</p>

        <h2>5. Consentimiento</h2>
        <p>El tratamiento se basa en su consentimiento libre, previo, expreso e informado (o del apoderado para menores). Al
            inscribirse o proporcionar datos, usted consiente el tratamiento para las finalidades indicadas. Excepciones al
            consentimiento (previstas por ley): cumplimiento de obligaciones contractuales o legales, o protección de derechos
            vitales.</p>

        <h2>6. Compartir y Transferencia de Datos</h2>
        <p>No vendemos ni comercializamos datos personales. Podemos compartirlos solo:</p>
        <ul>
            <li>Con proveedores de servicios tecnológicos (plataforma virtual, hosting, emisores de comprobantes electrónicos) bajo
                contratos que garantizan el mismo nivel de protección.</li>
        ...
        <p>No realizamos transferencias internacionales de datos a menos que se garantice nivel adecuado de protección (o con
        ...
        <p>Para ejercer estos derechos, envíe solicitud escrita a contacto@nextlevel.edu.pe con copia de DNI. Responderemos en
            máximo 10 días hábiles (prorrogable por 5 más si es complejo).</p>

        <h2>9. Cookies y Tecnologías Similares</h2>
        <p>Nuestro sitio usa cookies esenciales (para funcionamiento) y analíticas. Puede configurar su navegador para rechazarlas,
            pero esto puede afectar la experiencia.</p>

        <h2>10. Conservación de Datos</h2>
        <p>Conservamos los datos durante el tiempo necesario para cumplir la finalidad (durante la relación educativa + plazo legal
            para obligaciones fiscales o contractuales, usualmente 5-10 años según tipo de dato). Luego se bloquean o suprimen.</p>

        <h2>11. Modificaciones</h2>
        <p>Podemos actualizar esta Política. La versión vigente se publicará en el sitio web con la fecha de “Última actualización”.
            El uso continuado implica aceptación de los cambios.</p>

        <h2>12. Ley Aplicable y Solución de Controversias</h2>
        <p>Esta Política se rige por las leyes del Perú. Cualquier controversia se resolverá primero por conciliación; de no
            lograrse acuerdo, ante los juzgados de Lima, Perú.</p>
        <h2>13. Tratamiento de Imágenes y Datos Personales de Menores de Edad (Fotografías, Videos y Otros Registros Visuales)</h2>
        <p>Next Level School reconoce que las imágenes (fotografías, videos, grabaciones audiovisuales o cualquier registro que
            permita identificar a una persona) constituyen datos personales conforme a la Ley N° 29733 y su Reglamento (Decreto
            Supremo N° 016-2024-JUS). Cuando se trate de menores de edad (estudiantes menores de 18 años), aplicamos reglas
            especiales de protección para salvaguardar su intimidad, honra e interés superior.</p>

        <h3>13.1 Finalidades específicas del tratamiento de imágenes</h3>
        <p>Podremos captar, reproducir, difundir o publicar imágenes de estudiantes únicamente para fines educativos y
        ...
        <p>No utilizaremos las imágenes para fines comerciales directos (publicidad pagada, venta de productos) ni para
            tratamientos no informados previamente.</p>

        <h3>13.2 Consentimiento requerido</h3>
        <ul>
            <li>Para menores de 14 años: El tratamiento de sus imágenes solo es lícito con el consentimiento expreso, previo,
                informado e inequívoco de los padres, tutores o representantes legales que ejerzan la patria potestad o tutela.</li>
            <li>Para mayores de 14 años y menores de 18 años: El menor podrá otorgar su consentimiento directamente, siempre que la
                información se proporcione en un lenguaje claro y comprensible adaptado a su edad. No obstante, por prudencia y en
                cumplimiento de buenas prácticas educativas, recomendamos y solicitaremos preferentemente el consentimiento
                adicional de los apoderados.</li>
        </ul>
        <p>El consentimiento se obtendrá mediante:</p>
        <ul>
            <li>Formulario específico durante la matrícula/inscripción (físico o digital).</li>
            <li>Casilla expresa en formularios en línea con verificación razonable (por ejemplo, envío de correo o WhatsApp al
                apoderado para confirmación).</li>
        </ul>

        <h3>13.3 Características del consentimiento</h3>
        <ul>
            <li>Será específico para el uso de imágenes (no genérico).</li>
            <li>Informará claramente: finalidades, medios de difusión (web, redes, etc.), duración (durante la relación educativa o
                hasta revocación), y que es revocable en cualquier momento sin retroactividad ni perjuicio.</li>
        ...
        <p>Realizaremos esfuerzos razonables (según tecnología disponible) para verificar la edad del estudiante y la
            identidad/autorización del apoderado en tratamientos por Internet (art. 25 del Reglamento). Si no contamos con
            consentimiento expreso:</p>
        <ul>
            <li>No publicaremos imágenes identificables del menor.</li>
            <li>Usaremos alternativas como imágenes borrosas, de espaldas, grupales sin enfoque en rostros, o sin publicación
                pública.</li>
        </ul>

        <h3>13.5 Revocación y derechos</h3>
        <p>El consentimiento para el uso de imágenes es revocable en cualquier momento mediante comunicación escrita o por correo a
            contacto@nextlevel.edu.pe. Procederemos a retirar o anonimizar las imágenes publicadas en un plazo razonable (máximo 10
            días hábiles). Los apoderados o el menor (si >14 años) podrán ejercer los derechos ARCO (acceso, rectificación,
            cancelación, oposición) respecto de sus imágenes, conforme a la sección 8 de esta Política.</p>

        <h3>13.6 Prohibiciones</h3>
        <p>No recopilaremos ni trataremos imágenes que revelen información innecesaria sobre el grupo familiar del menor sin
            consentimiento adicional (art. 23 del Reglamento). No compartiremos imágenes con terceros sin base legal o
            consentimiento expreso.</p>
        ...
        <p class="final">Al utilizar nuestros servicios, usted y/o su apoderado declaran haber leído, entendido y aceptado nuestra
