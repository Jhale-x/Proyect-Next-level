...
Route::prefix('docente')->middleware(['auth', 'role:docente'])->group(function () {
    ...
    Route::get('/courses', [CourseController::class, 'docenteIndex'])->name('docente.courses');
...
Route::prefix('alumno')->middleware(['auth:alumno'])->group(function () {
    ...
    Route::prefix('/messages')->group(function () {
        ...
        Route::get('/cursos', [MessageController::class, 'cursosAlumno']);
        Route::get('/inbox', [MessageController::class, 'inboxAlumno']);
        Route::get('/chat/{id_curso}', [MessageController::class, 'chatAlumno']);
        Route::get('/conversaciones', [MessageController::class, 'conversacionesAlumno']);
        Route::post('/store', [MessageController::class, 'storeAlumno']);
        Route::get('/chat-private/{id_usuario}', [MessageController::class, 'chatPrivateAlumno']);
        Route::post('/store', [MessageController::class, 'storeAlumno']);
    });
