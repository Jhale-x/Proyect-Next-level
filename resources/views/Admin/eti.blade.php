    ...
    <div class="container-fluid py-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-6">
                <button class="btn btn-outline-primary w-100 py-3 shadow-sm fw-bold border-2 active-btn" id="btnColegio"
                    onclick="seleccionarModalidad('colegio')">
                    <i class="bi bi-building me-2"></i> COLEGIO
                </button>
            </div>
            <div class="col-12 col-md-6">
                <button class="btn btn-outline-danger w-100 py-3 shadow-sm fw-bold border-2" id="btnAcademia"
        ...
        <div class="card shadow-sm border-0 mb-4 bg-light">
            <div class="card-body">
                <div id="filtros-colegio" class="row g-3">
                    <div class="col-md-4">
                        <label for="nivel_eti" class="form-label fw-bold text-primary">Nivel</label>
                    ...
                    <div class="col-md-4">
                        <label for="grado_eti" class="form-label fw-bold text-primary">Grado</label>
                        <select id="grado_eti" class="form-select border-primary">
                    ...
                    <div class="col-md-4">
                        <label for="seccion_eti" class="form-label fw-bold text-primary">Sección</label>
                        <select id="seccion_eti" class="form-select border-primary">
                            <option>A</option>
                            <option>B</option>
                            <option>C</option>
                        </select>
                ...
                <div id="filtros-academia" class="row g-3 d-none">
                    <div class="col-md-12">
                        <label for="facultad_eti" class="form-label fw-bold text-danger">Facultad / Área</label>
                        <select id="facultad_eti" class="form-select border-danger">
                                ...
                                <tr class="text-center">
                                    ...
                                    @for ($i = 1; $i <= 10; $i++)
                                        <td class="p-1 border-start">
                                            <input type="number"
                                                class="form-control form-control-sm text-center border-0 bg-transparent input-semana"
