...
<div class="container-fluid py-4" style="background-color: #1a1d21; min-height: 100vh;">
    ...
    <form action="{{ route('admin.users.index') }}" method="GET" class="row g-2 mb-4">
        ...
        <div class="col-md-3">
            <select name="rol" class="form-select" style="background-color: #fff; border: none; border-radius: 5px; padding: 10px;">
        ...
        <div class="col-md-2">
            <button type="submit" class="btn btn-primary w-100" style="background-color: #007bff; border: none; padding: 10px;">Buscar</button>
        </div>
        <div class="col-md-2">
            <a href="{{ route('admin.users.index') }}" class="btn btn-secondary w-100" style="background-color: #6c757d; border: none; padding: 10px;">Limpiar</a>
        </div>
    </form>
        ...
        <table class="table table-dark table-hover mb-0" style="background-color: #212529; border: none;">
            <thead style="border-bottom: 2px solid #2d3238;">
                <tr>
                    ...
                    <th style="color: #17a2b8; font-weight: bold; border: none;">Cargo/Materia</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #2d3238;">
                    ...
                    <td class="align-middle" style="border: none;">
                        {{ $user->cursoRelacion->materia ?? ucfirst($user->rol) }}
                    </td>
                    ...
                    <td class="align-middle text-center" style="border: none;">
                        <button class="btn btn-sm btn-outline-info" style="border-color: #17a2b8; color: #17a2b8;">Ver</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
