...
@section('content')
        ...
        <div class="conversations-grid">
            ...
            @foreach ($cursos as $curso)
                <div class="conversation-card"
                    onclick="AdminMessages.abrirCurso({{ $curso->id_curso }}, '{{ $curso->materia }}')">
    ...
    <div id="inboxModal" class="chat-panel">
        ...
        <div class="chat-header">
            ...
            <button onclick="AdminMessages.closeInbox()">✖</button>
        </div>
        ...
        <div class="chat-float-button">
            <button onclick="AdminMessages.nuevaConversacion()">
                ➕ Nueva conversación
            </button>
        </div>
    ...
    <div id="selectUserModal">
        ...
        <div class="chat-header">
            ...
            <button onclick="AdminMessages.closeSelectUser()">✖</button>
        </div>
        ...
        <div class="search-box" style="padding: 15px; border-bottom: 1px solid #ddd;">
            <input type="text" id="searchUserInput" placeholder="🔍 Buscar usuario..."
                onkeyup="AdminMessages.buscarUsuario()"
    ...
    <div id="chatModal">
        ...
        <div class="chat-header">
            ...
            <button onclick="AdminMessages.closeChat()">✖</button>
        </div>
        ...
        <div class="chat-footer">
            ...
            <button onclick="AdminMessages.sendMessage()">➤</button>
        </div>
