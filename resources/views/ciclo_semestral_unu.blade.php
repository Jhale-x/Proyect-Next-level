...
<head>
    ...
    <title>Ciclo Semestral UNU | Next Level</title>
    <meta name="description" content="Refuerza tus conocimientos con el Ciclo Semestral UNU. Entrenamiento avanzado y resolución de exámenes pasados de la Universidad Nacional de Ucayali.">
    <meta name="keywords" content="semestral UNU, preparación avanzada ucayali, academia preuniversitaria UNU, ingreso directo">
    <meta property="og:title" content="Ciclo Semestral UNU | Next Level">
    <meta property="og:image" content="{{ asset('images/Logo-Next-Level.png') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/web/web_principal.css') }}">
    <link rel="stylesheet" href="{{ asset('css/web/marquee_principal.css') }}">
    <link rel="stylesheet" href="{{ asset('css/web/ciclo_semestral_unu.css') }}">
...
<body>
    ...
    <section class="section-ciclo-semestral-unu">
        <div class="container-minimal">
            <h2 class="title-display">¡CICLO SEMESTRAL!</h2>

            <div class="pricing-card-modern">
                <div class="card-info">
                    <span class="badge-status">DISPONIBLE 2026</span>
                    <h3 class="cycle-name">Ciclo Semestral <span>UNU</span></h3>
