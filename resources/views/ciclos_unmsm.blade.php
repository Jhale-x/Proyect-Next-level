...
<head>
    ...
    <title>Ciclos UNMSM | Next Level</title>
    <meta name="description" content="Prepárate para San Marcos en Pucallpa. Ciclo especializado en el examen de admisión UNMSM con simulacros tipo DECO y plana docente de primer nivel.">
    <meta name="keywords" content="ciclo san marcos, UNMSM Pucallpa, preparación deco, examen san marcos, academia next level">
    <meta property="og:title" content="Ciclo Especializado UNMSM | Next Level">
    ...
    <link rel="stylesheet" href="{{ asset('css/web/ciclos_unmsm.css') }}">
...
<body>
    ...
    <section class="section-ciclo-unmsm">
        <div class="container-minimal">
            <h2 class="title-display">¡CICLOS UNMSM!</h2>
        ...
        <div class="tab-content-container"></div>
            ...
            <div id="anual" class="ciclo-panel active">
                <div class="pricing-card-modern">
                    <div class="card-info">
                        ...
                        <h3 class="cycle-name">Ciclo Anual <span>UNMSM</span></h3>
            ...
            <div id="semestral" class="ciclo-panel">
                <div class="pricing-card-modern">
                    <div class="card-info">
                        <span class="badge-status">DISPONIBLE 2026</span>
                        <h3 class="cycle-name">Ciclo Semestral <span>UNMSM</span></h3>
                        <div class="date-minimal">
                            <div class="date-row">
                                <i class="fa-regular fa-calendar"></i>
                                <span>23 Mar - 05 Dic</span>
            ...
            <div id="verano" class="ciclo-panel">
                <div class="pricing-card-modern">
                    <div class="card-info">
                        <span class="badge-status">DISPONIBLE 2026</span>
                        <h3 class="cycle-name">Ciclo Verano <span>UNMSM</span></h3>
                        <div class="date-minimal">
                            <div class="date-row">
                                <i class="fa-regular fa-calendar"></i>
                                <span>23 Mar - 05 Dic</span>
