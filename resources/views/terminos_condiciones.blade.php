...
<body>
    ...
    <section class="terminos-condiciones">
        ...
        <p>Los servicios incluyen tanto educación formal regulada por el Ministerio de Educación del Perú (en los niveles de
            primaria y secundaria)<br> como prestación de servicios educativos privados complementarios (preparación
            preuniversitaria, refuerzo y talleres), y no sustituyen la educación formal regulada por el Ministerio de Educación del
            Perú.</p>
        ...
        <ul>
            ...
            <li>Las inscripciones y pagos deben ser realizados por el apoderado legal (padre, madre o tutor) si el estudiante es
                menor de 18 años.</li>
        ...
        <ul>
            <li>La inscripción se considera confirmada solo después de realizado el pago correspondiente y recibido el comprobante
                (boleta/factura electrónica).</li>
            <li>Toda inscripción implica la aceptación expresa de estos Términos y Condiciones.</li>
            <li>Los precios, horarios y vacantes se informan en la web o vía WhatsApp/oficina y pueden variar sin previo aviso (se
                comunicará con anticipación razonable).</li>
        </ul>

        <h2>5. Pagos y Política de Devoluciones</h2>
        <ul>
            <li>Los pagos se realizan mediante transferencia bancaria, depósito, Yape/Plin, tarjeta (si aplica) u otros medios
                indicados.</li>
            <li>No se realizan devoluciones de matrícula ni mensualidades una vez iniciado el ciclo/clase, salvo casos
                excepcionales valorados por la dirección (fuerza mayor debidamente acreditada).</li>
        ...
        <ul>
            <li>Next Level School no garantiza resultados académicos específicos (ingreso a universidad, notas, etc.), ya que
                dependen del esfuerzo personal del estudiante.</li>
            <li>No seremos responsables por daños indirectos, consecuenciales, lucro cesante o pérdida de datos derivados del uso
                de nuestros servicios.</li>
        </ul>

        <h2>10. Protección de Datos Personales</h2>
        <p>El tratamiento de datos personales se rige por nuestra Política de Privacidad (enlace en el pie de página), conforme a
            la Ley N° 29733 y su reglamento.</p>

        <h2>11. Modificaciones</h2>
        <p>Podemos modificar estos Términos en cualquier momento. La versión actualizada se publicará en la web y la fecha de
            “Última actualización” se modificará. El uso continuado del sitio/servicios tras la publicación implica aceptación de
            los cambios.</p>

        <h2>12. Ley Aplicable y Solución de Controversias</h2>
        <p>Estos Términos se rigen por las leyes de la República del Perú. Cualquier controversia será resuelta en primera
            instancia mediante conciliación. De no lograrse acuerdo, las partes se someten a la jurisdicción de los juzgados y
            tribunales de la ciudad de Lima, Perú, renunciando a cualquier otro fuero.</p>
        ...
        <p class="final">Al inscribirse o utilizar nuestros servicios, usted y/o su apoderado declaran haber leído, entendido y
