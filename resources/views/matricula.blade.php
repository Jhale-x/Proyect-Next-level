...
<head>
    ...
    <title>MatrÃ­culas | Next Level</title>
        ...
        <div class="marquee-wrapper">
            <div class="marquee-track" id="marqueeTrack">
                <div class="marquee-item">
                    Â¡MatrÃ­cula 2026! &nbsp;&nbsp;&nbsp;&nbsp;
                    â˜€ï¸ðŸŠâ€â™‚ï¸ Inicio de Clases: 4 Marzo &nbsp;&nbsp;&nbsp;&nbsp;
                </div>
            </div>
        </div>
    </div>
    ...
    <nav class="main-nav">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-trigger">NOSOTROS <span class="arrow-icon">â–¾</span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">QuÃ© ofrecemos</a></li>
            ...
            <div class="banner-overlay">
                <div class="banner-container">
                    <div class="enrollment-card">
                        ...
                        <h3>Â¡MatricÃºlate <br> 100% ONLINE AQUÃ!</h3>

                        {{-- CAMBIO CLAVE: Se cambiÃ³ la ruta a 'matricula.verificar.post' --}}
                        <form action="{{ route('matricula.verificar.post') }}" method="POST" class="enrollment-form">
                            ...
                            <div class="form-group">
                                <div class="select-wrapper">
                                    <select name="tipo_doc" id="tipo_doc" required>
                                        ...
                                        <option value="ce" {{ old('tipo_doc') == 'ce' ? 'selected' : '' }}>Carnet de ExtranjerÃ­a</option>
                                    </select>
                            ...
                            <div class="form-group">
                                <input type="text" name="documento" id="documento" placeholder="NÃºmero de documento" value="{{ old('documento') }}" maxlength="8" required>
                            </div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <div class="help-container">
                                        ...
                                        <div class="help-tooltip" id="helpTooltip">
                                            <p>El cÃ³digo es el nÃºmero despuÃ©s del guion en tu DNI.</p>
        ...
        <div class="footer-container">
            <div class="footer-left">
                ...
                <div class="footer-contact">
                    ...
                    <p><i class="fa-solid fa-location-dot"></i> Pucallpa, PerÃº</p>
                </div>
            </div>
            <div class="footer-bottom">
                <p>Â© 2026 Next Level. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    avisoCE.innerHTML = '<i class="fa-solid fa-triangle-exclamation"></i> Por ahora, la matrÃ­cula online solo estÃ¡ disponible para DNI.';
    ...
    tipoDoc.addEventListener('change', function() {
        ...
        if (this.value === 'ce') {
            ...
            inputDoc.placeholder = "NÃºmero de documento";
