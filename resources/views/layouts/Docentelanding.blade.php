...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Next Level - Docentes')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.bi/bootstrap-icons@1.11.1/font/bootstrap-icons.css" rel="stylesheet">
...
<body>
    <div class="mobile-header">
        ...
        <button class="btn btn-outline-light border-0" onclick="toggleSidebar()"><i class="bi bi-list fs-2"></i></button>
    </div>
