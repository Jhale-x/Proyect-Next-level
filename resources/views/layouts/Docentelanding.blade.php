...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Next Level Docente')</title>
...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                ...
                <div class="sidebar-item">
                    ...
                    <a href="{{ route('docente.courses') }}"
                        class="{{ request()->routeIs('docente.courses') || request()->routeIs('docente.eti') ? 'active' : '' }}"
                    ...
                    <div class="submenu" id="docente-cursos-items"
                        style="{{ request()->routeIs('docente.courses') || request()->routeIs('docente.eti') ? 'display:flex;flex-direction:column;' : 'display:none;' }}">

                        <a href="{{ route('docente.courses') }}"
                            class="{{ request()->routeIs('docente.courses') ? 'text-white fw-bold' : '' }}">
                            <i class="bi bi-collection me-2"></i> Mis Cursos
                        </a>

                        {{-- <!-- ETA -->
                        <a href="{{ route('docente.eti') }}"
                            class="{{ request()->routeIs('docente.eti') ? 'text-white fw-bold' : '' }}">
    ...
    <script src="{{ asset('js/docentes/course.js') }}"></script>
    @stack('scripts')
