...
@section('content')
    <div class="container-fluid py-4">
                ...
                <form>
                    <div class="row">
                        <div class="col-12 col-md-3 mb-3">
                            <label for="nombre_al_v" class="form-label">Nombre</label>
                            <input id="nombre_al_v" type="text" class="form-control" placeholder="Ej. Juan">
                        </div>
                        <div class="col-12 col-md-3 mb-3">
                            <label for="apellido_al_v" class="form-label">Apellido</label>
                            <input id="apellido_al_v" type="text" class="form-control" placeholder="Ej. Pérez">
                        </div>
                        <div class="col-12 col-md-3 mb-3">
                            <label for="dni_al" class="form-label fw-bold">DNI (Usuario)</label>
                            <input type="text" id="dni_al" class="form-control border-primary" maxlength="8">
                        </div>
                        <div class="col-12 col-md-3 mb-3">
                            <label for="fecha_al" class="form-label fw-bold">F. Nacimiento (Clave)</label>
                    ...
                    <div class="row align-items-end">
                        <div class="col-12 col-md-3 mb-3">
                            <label for="nivel" class="form-label text-primary fw-bold">Nivel Académico</label>
                        ...
                        <div class="col-12 col-md-4 mb-3 d-none" id="grupo-facultad">
                            <label for="facultad" class="form-label fw-bold text-danger">Facultad</label>
                    ...
                    <div class="row mt-2">
                        <div class="col-12 col-md-3 mb-3">
                            <label for="user_al" class="form-label small text-muted">Usuario Sugerido</label>
                            <input type="text" id="user_al" class="form-control bg-light fw-bold text-secondary"
                                readonly>
                        </div>
                        <div class="col-12 col-md-3 mb-3">
                            <label for="pass_al" class="form-label small text-muted">Contraseña Sugerida</label>
                            <input type="text" id="pass_al" class="form-control bg-light fw-bold text-secondary"
                                readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            <label for="nombre_apo_v" class="form-label">Nombre Completo</label>
                            <input id="nombre_apo_v" type="text" class="form-control">
                        </div>
                        <div class="col-12 col-md-3 mb-3">
                            <label for="dni_apo_v" class="form-label">DNI Apoderado</label>
                            <input id="dni_apo_v" type="text" class="form-control" maxlength="8">
                        </div>
                    </div>
                    <div class="mt-3">
        ...
        <div id="form-personal" class="card shadow-sm border-0 d-none mt-4">
            <div class="card-body p-3 p-md-4">
                ...
                <form>
                    <div class="row">
                        <div class="col-12 col-md-3 mb-3"><label for="nombre_per_v"
                                class="form-label">Nombre</label><input id="nombre_per_v" type="text"
                                class="form-control"></div>
                        <div class="col-12 col-md-3 mb-3"><label for="apellido_per_v"
                                class="form-label">Apellido</label><input id="apellido_per_v" type="text"
                                class="form-control"></div>
                        <div class="col-12 col-md-3 mb-3"><label for="dni_per" class="form-label fw-bold">DNI
                                (Usuario)</label><input type="text" id="dni_per"
                                class="form-control border-secondary" maxlength="8"></div>
                        <div class="col-12 col-md-3 mb-3"><label for="fecha_per" class="form-label fw-bold">F.
                                Cumpleaños</label><input type="date" id="fecha_per"
                                class="form-control border-secondary"></div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-3 mb-3">
                        ...
                        <div class="col-12 col-md-3 mb-3 d-none" id="grupo-materia">
                            <label for="materia_per_v" class="form-label fw-bold">Especialidad / Materia</label>
                            <select id="materia_per_v" class="form-select">
                        ...
                        <div class="col-12 col-md-3 mb-3">
                            <label for="user_per" class="form-label">Usuario</label>
                            <input type="text" id="user_per" class="form-control bg-light" readonly>
                        </div>
                        <div class="col-12 col-md-3 mb-3">
                            <label for="pass_per" class="form-label">Contraseña</label>
                            <input type="text" id="pass_per" class="form-control bg-light" readonly>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-secondary w-100 w-md-auto px-5 py-2 fw-bold shadow mt-3">Guardar
                        Personal</button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        function mostrarAlumno() {
            ...
            window.scrollTo({
                top: document.getElementById('form-alumno').offsetTop - 80,
                behavior: 'smooth'
            });
        }
        ...
        function mostrarPersonal() {
            ...
            window.scrollTo({
                top: document.getElementById('form-personal').offsetTop - 80,
                behavior: 'smooth'
            });
        }
        ...
        document.getElementById('nivel').addEventListener('change', function() {
            ...
            if (this.value === 'academia') {
                ...
                for (let i = 1; i <= limite; i++) {
                    g.innerHTML +=
                        `<option value="${i}">${i}° ${this.value.charAt(0).toUpperCase() + this.value.slice(1)}</option>`;
                }
            }
        });
