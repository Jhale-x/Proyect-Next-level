...
/**
 * Función para entrar a la vista de detalle de un curso
 */
window.entrarAlCurso = function(nombre, docente) {
    ...
    // Intercambio de vistas con animación simple
...
/**
 * Función para regresar al listado general
 */
...
/**
 * Manejador de pestañas de Bimestres
 */
window.cambiarBimestre = function(numero, elemento) {
    ...
    // Aquí podrías agregar una petición AJAX para traer notas reales
};