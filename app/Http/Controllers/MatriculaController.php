...
class MatriculaController extends Controller
{
        ...
        try {
            ...
            if ($response->successful() && isset($datos['success']) && $datos['success']) {
                ...
                if ($cvReal !== null && $codigoUsuario == $cvReal) {
                    ...
                    return redirect()->back()->with('error', 'El código de verificación (CV) es incorrecto.')->withInput();
                }
            }
            return redirect()->back()->with('error', 'DNI no encontrado.')->withInput();
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Error de conexión con RENIEC.');
        }
    }
    ...
    public function getCuotas($ciclo_id)
    {
    ...
    public function procesarMatricula(Request $request)
    {
        ...
        try {
            return DB::transaction(function () use ($request) {
                ...
                // Obtener el ciclo para obtener la información
                ...
                // Crear matrícula con las columnas correctas de la tabla
            ...
            \Log::error("Error Matrícula: " . $e->getMessage());
            return response()->json([
                'success' => false, 
