    ...
    <?php $__env->startSection('content'); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="nivel" onchange="cargarGrados()">
                                    ...
                                    <?php $__currentLoopData = $niveles ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($nivel->id_nivel); ?>"><?php echo e($nivel->nivel); ?></option>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <th>
                                                ...
                                                <br>
                                                <small><?php echo e($actividad->porcentaje); ?>%</small>
                                            </th>
        ...
        <script>
            ...
            async function cargarAlumnos() {
                ...
                const res = await fetch('/auxiliar/eta/alumnos', {
                    method: 'POST',
                    headers: {
            ...
            async function cargarNotas() {
                const res = await fetch('/auxiliar/eta/notas');
                const data = await res.json();
            ...
            function renderizarTabla(alumnos) {
                ...
                const actividades = <?php echo json_encode($actividades, 15, 512) ?>;
            ...
            async function guardarIndividual(id) {
                ...
                for (const i of inputs) {
                    ...
                    if (!isNaN(valor)) {
                        ...
                        requests.push(
                            fetch('/auxiliar/eta/guardar-promedio', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
            ...
            function exportarPromedios() {
                window.location.href = '/auxiliar/eta/exportar';
            }
        </script>

    <?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.Auxiliarlanding', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Proyect_Next_Level\resources\views/Auxiliar/eta.blade.php ENDPATH**/ ?>