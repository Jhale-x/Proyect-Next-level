...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/activity.css')); ?>">
...
<body>
    ...
    <div class="d-flex">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                <a href="<?php echo e(route('admin.pagina_institucional')); ?>" class="<?php echo e(request()->routeIs('admin.pagina_institucional') ? 'active' : ''); ?>">
                    <i class="bi bi-house-door"></i>
                    <span>Página Institucional</span>
                </a>

                <a href="<?php echo e(route('admin.activity')); ?>" class="<?php echo e(request()->routeIs('admin.activity') ? 'active' : ''); ?>">
                ...
                <div class="sidebar-item">
                    ...
                    <div class="submenu" id="registro-items" style="display: none;">
                        <a href="<?php echo e(route('admin.registro.alumno')); ?>">
                ...
                <div class="sidebar-item">
                    ...
                    <div class="submenu" id="listado-items" style="display: none;">
                        <a href="<?php echo e(route('admin.listado.alumnos')); ?>">
                            <i class="bi bi-person-workspace me-2"></i> Lista de Alumnos
                        </a>
                        <a href="<?php echo e(route('admin.listado.personal')); ?>">
                            <i class="bi bi-person-badge me-2"></i> Lista de Personal
                        </a>
                    </div>
                </div>

                <a href="<?php echo e(route('admin.organizations')); ?>" class="<?php echo e(request()->routeIs('admin.organizations') ? 'active' : ''); ?>">
                    <i class="bi bi-diagram-3"></i>
                    <span>Organizaciones</span>
                </a>

                <a href="<?php echo e(route('admin.calendar')); ?>" class="<?php echo e(request()->routeIs('admin.calendar') ? 'active' : ''); ?>">
                    <i class="bi bi-calendar-event"></i>
                    <span>Calendario</span>
                </a>

                <a href="<?php echo e(route('admin.messages')); ?>" class="<?php echo e(request()->routeIs('admin.messages') ? 'active' : ''); ?>">
                    <i class="bi bi-envelope"></i>
                    <span>Mensajes</span>
                </a>

                <a href="<?php echo e(route('admin.tools')); ?>" class="<?php echo e(request()->routeIs('admin.tools') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\Proyect-Next-level\resources\views/layouts/Adminlanding.blade.php ENDPATH**/ ?>