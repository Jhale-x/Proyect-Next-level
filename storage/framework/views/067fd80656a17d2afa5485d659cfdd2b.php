...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/docente/paginaInstitucional.css')); ?>">
<?php $__env->stopPush(); ?>
        ...
        <div class="institutional-header">
            ...
            <div>
                ...
                <p class="institutional-subtitle">
                    Comunicados y anuncios oficiales para docentes.
                </p>
            </div>
                    ...
                    <div class="announcement-body">
                        ...
                        <?php if($anuncio->contenido): ?>
                            <div class="announcement-content">
                                <?php echo nl2br(e($anuncio->contenido)); ?>
...
<?php echo $__env->make('layouts.Docentelanding', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\Proyect_Next_Level\resources\views/Docentes/pagina_institucional.blade.php ENDPATH**/ ?>