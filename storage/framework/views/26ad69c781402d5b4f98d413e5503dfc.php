...
<body>
    ...
    <div class="d-flex">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                <a href="<?php echo e(route('auxiliar.pagina_institucional')); ?>"
                    class="<?php echo e(request()->routeIs('auxiliar.pagina_institucional') ? 'active' : ''); ?>">
                    <i class="bi bi-house-door"></i>
                    <span>Pagina Institucional</span>
                </a>

                <a href="<?php echo e(route('auxiliar.eta')); ?>"
                    class="<?php echo e(request()->routeIs('auxiliar.eta') ? 'active' : ''); ?>">
                    <i class="bi bi-envelope"></i>
                    <span>ETA</span>
                </a>

                <a href="<?php echo e(route('auxiliar.messages')); ?>"
                    class="<?php echo e(request()->routeIs('auxiliar.messages') ? 'active' : ''); ?>">
                    <i class="bi bi-envelope"></i>
                    <span>Mensajes</span>
                </a>

                <a href="<?php echo e(route('auxiliar.tools')); ?>"
                    class="<?php echo e(request()->routeIs('auxiliar.tools') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\laravel\Proyect_Next_Level\resources\views/layouts/Auxiliarlanding.blade.php ENDPATH**/ ?>