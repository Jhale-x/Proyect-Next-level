...
<body>
    <a href="https://www.nextlevelschool.edu.pe" class="back-home-btn" title="Volver al Inicio">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 12H5M5 12L12 19M5 12L12 5" stroke="white" stroke-width="2.5" stroke-linecap="round"
                stroke-linejoin="round" />
        </svg>
    </a>
    <a href="<?php echo e(route('login.user')); ?>" class="btn-docente">
        Docentes
    </a>
    ...
    <div class="main-split-viewport">
        <section class="portal-section colegio">
            ...
            <div class="info-container">
                ...
                <a href="<?php echo e(route('login.colegio')); ?>" class="btn-main">
                    <span>Ingresar</span>
                </a>
            </div>
        </section>
        ...
        <section class="portal-section academia">
            ...
            <div class="info-container">
                ...
                <a href="<?php echo e(route('login.academia')); ?>" class="btn-main">
                    <span>Ingresar</span>
                </a>
            </div>
        </section>
...
<?php /**PATH C:\xampp\htdocs\laravel\Proyect_Next_Level\resources\views/intranet.blade.php ENDPATH**/ ?>