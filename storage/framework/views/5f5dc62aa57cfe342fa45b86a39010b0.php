...
<body>
    ...
    <div class="d-flex">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="menu">
                <a href="<?php echo e(route('alumno.pagina_institucional')); ?>"
                    class="<?php echo e(request()->routeIs('alumno.pagina_institucional') ? 'active' : ''); ?>">
                    <i class="bi bi-house-door"></i>
                    <span>Pagina Institucional</span>
                </a>
                <a href="<?php echo e(route('alumno.courses')); ?>"
                    class="<?php echo e(request()->routeIs('alumno.courses') ? 'active' : ''); ?>">
                    <i class="bi bi-journal-bookmark"></i>
                    <span>Cursos</span>
                </a>

                <a href="<?php echo e(route('alumno.activity')); ?>"
                    class="<?php echo e(request()->routeIs('alumno.activity') ? 'active' : ''); ?>">
                    <i class="bi bi-activity"></i>
                    <span>Actividad</span>
                </a>

                <a href="<?php echo e(route('alumno.calendar')); ?>"
                    class="<?php echo e(request()->routeIs('alumno.calendar') ? 'active' : ''); ?>">
                    <i class="bi bi-calendar-event"></i>
                    <span>Calendario</span>
                </a>

                <a href="<?php echo e(route('alumno.messages')); ?>"
                    class="<?php echo e(request()->routeIs('alumno.messages') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('alumno.tools')); ?>"
                    class="<?php echo e(request()->routeIs('alumno.tools') ? 'active' : ''); ?>">
                ...
                <div class="d-flex align-items-center gap-2 ms-auto">
                    ...
                    <div class="dropdown">
                        <button class="btn admin-user-trigger dropdown-toggle d-flex align-items-center gap-2"
                            ...
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(($currentUser->nombre ?? '') . ' ' . ($currentUser->apellido ?? ''))); ?>&background=0D6EFD&color=fff"
                                class="rounded-circle" width="34" height="34" alt="Avatar">
                            <div class="text-start d-none d-sm-block">
                                <div class="fw-semibold" style="line-height:1;"><?php echo e($currentUser->nombre ?? 'Usuario'); ?>

                                    <?php echo e($currentUser->apellido ?? ''); ?></div>
                                <small class="text-muted text-capitalize"><?php echo e($currentUser->rol ?? ''); ?></small>
                            </div>
                        </button>
...
<?php /**PATH C:\xampp\htdocs\laravel\Proyect_Next_Level\resources\views/layouts/Alumnoslanding.blade.php ENDPATH**/ ?>