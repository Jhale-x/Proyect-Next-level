            ...
            <div class="row g-3">
                <?php $__currentLoopData = $cursos ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4 col-lg-3">
                        <div class="course-card" onclick="abrirMateria('<?php echo e($curso->materia); ?>', <?php echo e($curso->id_curso); ?>)">
                            <div class="course-bar"></div>
                            <div class="p-3">
                                <h6 class="fw-bold"><?php echo e($curso->materia); ?></h6>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.Adminlanding', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Proyect-Next-level\resources\views/Admin/courses.blade.php ENDPATH**/ ?>