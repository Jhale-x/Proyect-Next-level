...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/login_academia.css')); ?>">
</head>
    ...
    <div class="main-sliding-container active" id="mainContainer">
        ...
        <div class="form-side family-side">
            <div class="max-w-xl w-full mx-auto text-center">
                <div class="mb-14">
                    <p class="text-custom-red italic text-lg md:text-xl font-bold tracking-[0.4em] uppercase mb-4">
                        Intranet</p>
                    <h1 class="text-6xl md:text-9xl font-black text-custom-red tracking-tighter uppercase leading-none">
                        Academia</h1>
                </div>

                <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-12 italic">¡Bienvenida Familia!</h2>

                <form class="space-y-8 text-left" method="POST" action="<?php echo e(route('login.familia')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                    ...
                    <button type="submit"
                        class="w-full btn-custom-effect text-white font-black py-8 rounded-[2rem] shadow-custom-red text-3xl uppercase tracking-widest mt-6">
                        <span>Ingresar</span>
                    </button>
                </form>
                ...
                <div class="mt-8">
                    <a href="#"
                        class="text-xl font-bold text-slate-400 hover:text-custom-red transition-colors">¿Olvidaste tu
                        contraseña?</a>
                </div>

                <div class="social-icons-wrapper !mt-8">
                    <a href="https://www.tiktok.com/@next_level_novus" target="_blank" rel="noopener noreferrer"
                        class="social-btn"><i class="fab fa-tiktok"></i></a>
                    <a href="https://www.instagram.com/next_level_novus/" target="_blank" rel="noopener noreferrer"
                        class="social-btn"><i class="fab fa-instagram"></i></a>
                    <a href="https://wa.me/51923317625" target="_blank" rel="noopener noreferrer" class="social-btn"><i
                            class="fab fa-whatsapp"></i></a>
                    <a href="https://www.facebook.com/profile.php?id=61581492196914" target="_blank"
                        rel="noopener noreferrer" class="social-btn"><i class="fab fa-facebook"></i></a>
                </div>

                <div class="mt-6 flex flex-col items-center">
                    <div
                        class="text-slate-400 text-[11px] font-bold uppercase tracking-widest flex items-center gap-3 whitespace-nowrap footer-links">
                        <a href="#"
                            class="hover:text-custom-red underline decoration-1 underline-offset-4 transition-colors">Términos
                            y condiciones</a>
                        <span class="text-slate-300">/</span>
                        <a href="#"
                            class="hover:text-custom-red underline decoration-1 underline-offset-4 transition-colors">Política
        ...
        <div class="form-side student-side">
            <div class="absolute top-8 left-8 md:top-12 md:left-12 container-back-btn">
                <a href="<?php echo e(route('portal')); ?>"
                    class="inline-block btn-custom-effect rounded-2xl p-4 shadow-custom-red">
            ...
            <div class="max-w-xl w-full mx-auto text-center academy-content-wrapper">
                ...
                <form class="space-y-8 text-left" method="POST" action="<?php echo e(route('login.alumno')); ?>">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-6 flex flex-col items-center">
                    <div
                        ...
                        <a href="#" class="hover:text-custom-red underline transition-colors">Términos y
                            condiciones</a>
                        <span class="text-slate-300">/</span>
                        <a href="#" class="hover:text-custom-red underline transition-colors">Política de
        ...
        <div class="sliding-panel-container">
            <div class="sliding-panel">
                <div class="text-white text-center px-10 md:px-20">
                    <h1 class="text-5xl md:text-8xl font-black mb-10 uppercase tracking-tighter" id="overlayTitle">
                        ¿Eres Familia?</h1>
                    <p class="text-2xl md:text-3xl opacity-90 mb-14 font-medium" id="overlayText">Accede con tu
                        documento de identidad para el <br class="hidden md:block"> seguimiento de tus hijos.</p>
...
<?php /**PATH C:\xampp\htdocs\laravel\Proyect_Next_Level\resources\views/auth/login_academia.blade.php ENDPATH**/ ?>