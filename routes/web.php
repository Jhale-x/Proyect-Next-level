...
Route::prefix('auth')->group(function () {
    ...
    Route::get('/auth.login-academia', fn() => view('login_academia'))->name('login.academia');
    Route::get('/auth.login-colegio', [LoginController::class, 'showColegio'])->name('login.colegio');
    Route::post('/auth.login-alumno', [LoginController::class, 'loginAlumno'])->name('login.alumno');
    Route::post('/auth.login-familia', [LoginController::class, 'loginFamilia'])->name('login.familia');
    Route::post('/logout', [LoginController::class, 'logout'])->name('logout');
    Route::get('/auth.login-user', [LoginController::class, 'showUser'])->name('login.user');
    Route::post('/auth.login-user', [LoginController::class, 'loginUser'])->name('login.user');
});
...
Route::prefix('admin')->middleware(['auth', 'role:administrador'])->group(function () {
    ...
    Route::prefix('courses')->group(function () {
        ...
        Route::get('/{id_usuario}/salones', [CourseController::class, 'salonesPorDocente']);
        Route::get('/{id}/salones', [CourseController::class, 'salones']);
