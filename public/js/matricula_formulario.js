...
async function cargarSelect(selectId, endpoint, textoDefault) {
    ...
    if (datos && datos.length > 0) {
        ...
        console.log(`âœ… ${textoDefault} cargados: ${datos.length} opciones`);
    } else {
        console.warn(`âš ï¸ No se recibieron ${textoDefault}`);
        select.disabled = false;
    }
}
...
async function cargarCiclosAcademia() {
    ...
    if (ciclos && ciclos.length > 0) {
        ...
        console.log(`âœ… Ciclos cargados: ${ciclos.length} opciones`);
    } else {
...
function inicializarAcademia() {
    console.log('ðŸŽ“ Inicializando Academia...');
...
// ======================================================
// ACTUALIZAR RESUMEN (Paso 2 â†’ Paso 3)
// ======================================================
...
// ======================================================
// GUARDAR MATRÃCULA Y AVANZAR AL PASO 4
// ======================================================
async function guardarMatricula() {
    ...
    try {
        ...
        if (response.success) {
            // Mostrar el cÃ³digo generado en el paso 4
            ...
            // Ocultar botones de navegaciÃ³n del paso 2
        ...
        alert('Error al procesar la matrÃ­cula');
        return false;
    }
}
...
// ======================================================
// BOTÃ“N DE NAVEGACIÃ“N - PASO 1 A PASO 2
// ======================================================
function inicializarBotonContinuar() {
    ...
    if (btnContinuar) {
        ...
        console.log('âœ… BotÃ³n Continuar inicializado');
    }
}

// ======================================================
// BOTÃ“N DE NAVEGACIÃ“N - PASO 2 A PASO 3
// ======================================================
function inicializarBotonPaso2() {
    ...
    if (btnPaso2) {
        ...
        nuevoBtn.addEventListener('click', async function() {
            console.log('BotÃ³n paso 2 clickeado');
        ...
        console.log('âœ… BotÃ³n paso 2 inicializado');
    } else {
        console.error('âŒ No se encontrÃ³ el botÃ³n #btn-finalizar-matricula');
    }
}
...
function inicializarBotonRegresar() {
    ...
    if (btnRegresar) {
        ...
        console.log('âœ… BotÃ³n Regresar inicializado');
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Sistema de matrÃ­cula listo');
});